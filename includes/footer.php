        ...
        <div class="footer-content grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="footer-section">
                <div class="footer-logo">
                    <img src="<?php echo $base; ?>public/assets/logo.svg?v=<?php echo time(); ?>" alt="Sintrix Logo">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="pages/telefonia-voip.php">Telefonia VoIP</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="pages/whatsapp-bot.php">WhatsApp Bot</a></li>
                        <li><a href="pages/cloud-data.php">Cloud Data</a></li>
                        <li><a href="pages/vpn-corporativa.php">Serviços VPN</a></li>
                    </ul>
